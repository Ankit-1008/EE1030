...
\begin{enumerate}
    ...
    \item -3
\end{enumerate}
\item The number of values of x in the interval [0,5$\pi$] satisfying equation 3 sin($^2x$)-7$sinx$+2=0 \hfill(1998-2 Marks) \
\begin{enumerate}
    \item 0
    \item 5
    \item 6
...
$f_(n)(\theta) = (\tan\frac{\theta}{2})(1+\sec\theta)(1+\sec2\Theta)(1+\sec4\theta)\dots(1+\sec2^n\theta).$ Then\hfill (1999 - 3Marks)
\begin{enumerate}
