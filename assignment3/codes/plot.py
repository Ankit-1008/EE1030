...
x = np.linspace(-1, 1, 1000)  # Extend the range to [-1, 1] for the full parabola
...
plt.legend()
plt.grid(True)
plt.xlim([-1, 1])  # Adjust the x-axis limits to [-1, 1] for full parabola
plt.ylim([0, 1])   # Keep the y-axis limit to show the relevant region
plt.show()
